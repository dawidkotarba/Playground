...
CREATE SEQUENCE NEIGHBOUR_SEQ INCREMENT BY 1;
...
CREATE CACHED TABLE PUBLIC.NEIGHBOUR (
  ID INT NOT NULL DEFAULT nextval('NEIGHBOUR_SEQ') PRIMARY KEY,
  COUNTRY    VARCHAR(50) NOT NULL,
  NEIGHBOUR  VARCHAR(50) NOT NULL,
  FOREIGN KEY (COUNTRY) REFERENCES COUNTRY(NAME),
  FOREIGN KEY (NEIGHBOUR) REFERENCES COUNTRY(NAME)
);